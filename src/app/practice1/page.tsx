        ...
        <>
            <header>
                <nav className="flex justify-between text-sm items-center w-3/5 mx-auto py-2.5">
                    <h1><Image src="/img/logo.svg" alt="Profile" width={120} height={40} /></h1>
                    <ul className="flex gap-7.5">
                        <li><Link href="#">About</Link></li>
                        <li><Link href="#">Bicycle</Link></li>
                    </ul>
                </nav>
            </header>

            <main>
                <Image src="/img/mainvisual.jpg" alt="白い自転車" width={2000} height={1000} className="w-full h-150 object-cover" />
                ...
                <section>
                    ...
                    <div className="flex w-2/5 mx-auto mt-17.5">
                        <Image src="/img/about.jpg" alt="緑の帽子を被った男性" width={100} height={100} className="rounded-full" />
            ...
            <footer>
                <p className="text-[8px] text-center mt-27.5 mb-2.5"><small>&copy;</small>2020 Profile</p>
            </footer>
        </>
    )
}